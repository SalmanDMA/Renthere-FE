    ...
    <section class="flex flex-col gap-3">
      <div>
        <input
          ...
          :class="{
            'outline-red-500 focus:outline-red-500': hasError('name'),
          }"
      ...
      <div>
        <input
          ...
          class="w-full bg-[#262e49] py-4 px-3 rounded-md text-[#d6d6d6] outline-none border-none placeholder:text-[#565f79] focus:outline-1 focus:outline-[#79a6fe]"
          :class="{
            'outline-red-500 focus:outline-red-500': hasError('email'),
          }"
      ...
      <div class="relative">
        <input
          ...
          class="w-full bg-[#262e49] py-4 px-3 rounded-md text-[#d6d6d6] outline-none border-none placeholder:text-[#565f79] focus:outline-1 focus:outline-[#79a6fe]"
          :class="{
            'outline-red-500 focus:outline-red-500': hasError('password'),
          }"
